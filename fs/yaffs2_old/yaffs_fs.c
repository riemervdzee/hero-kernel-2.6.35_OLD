...
#ifdef CONFIG_OYAFFS_DISABLE_WRITE_VERIFY
	T(YAFFS_TRACE_OS,
...
#ifndef CONFIG_OYAFFS_DOES_ECC
	dev->useNANDECC = 1;
#endif

#ifdef CONFIG_OYAFFS_DISABLE_WIDE_TNODES
