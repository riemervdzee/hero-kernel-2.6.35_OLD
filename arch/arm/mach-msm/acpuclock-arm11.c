...
#endif
 /* Table of freq we currently use. */
...
static struct clkctl_acpu_speed  msm7200_tbl[] = {
#if defined(CONFIG_JESUS_PHONE)
	{ 19200, ACPU_PLL_TCXO, 0, 0, 19200, 0, VDD_0, 30720, 0, 0, 3 },
	...
	{ 245760, ACPU_PLL_0, 4, 0, 81920, 2, VDD_4, 61440, 0, 0, 6 },
	{ 264000, ACPU_PLL_2, 2, 3, 88000, 2, VDD_3, 128000, 0, 0, 8 },
	{ 352000, ACPU_PLL_2, 2, 2, 88000, 3, VDD_5, 128000, 0, 3, 13 },
	{ 480000, ACPU_PLL_1, 1, 1, 120000, 3, VDD_6, 120000, 0, 4, 20 },
	{ 518400, ACPU_PLL_2, 2, 1, 132000, 3, VDD_6, 160000, 0, 5, -1, 0x1b },
	{ 528000, ACPU_PLL_2, 2, 1, 132000, 3, VDD_6, 160000, 0, 5, -1 },
	{ 537600, ACPU_PLL_2, 2, 1, 132000, 3, VDD_6, 160000, 0, 6, -1, 0x1c },
	{ 556800, ACPU_PLL_2, 2, 1, 132000, 3, VDD_6, 160000, 0, 6, -1, 0x1d },
	{ 576000, ACPU_PLL_2, 2, 1, 132000, 3, VDD_6, 160000, 0, 6, -1, 0x1e },
	{ 595200, ACPU_PLL_2, 2, 1, 132000, 3, VDD_7, 160000, 0, 6, -1, 0x1f },
	{ 614400, ACPU_PLL_2, 2, 1, 132000, 3, VDD_7, 160000, 0, 8, -1, 0x20 },
	{ 633600, ACPU_PLL_2, 2, 1, 132000, 3, VDD_7, 160000, 0, 8, -1, 0x21 },
	{ 652800, ACPU_PLL_2, 2, 1, 132000, 3, VDD_7, 160000, 0, 8, -1, 0x22 },
	{ 672000, ACPU_PLL_2, 2, 1, 132000, 3, VDD_7, 160000, 0, 8, -1, 0x23 },
	{ 691200, ACPU_PLL_2, 2, 1, 132000, 3, VDD_7, 160000, 0, 8, -1, 0x24 },
	{ 710400, ACPU_PLL_2, 2, 1, 132000, 3, VDD_7, 160000, 0, 8, -1, 0x25 },
...
static struct clkctl_acpu_speed  msm7600_tbl[] = {
#if defined(CONFIG_JESUS_PHONE)
...
static struct cpufreq_frequency_table msm7200_freq_table[] = {
#if defined(CONFIG_JESUS_PHONE)
        { 0,  19200 },
        { 1, 176000 },
        { 2, 352000 },
...
static struct cpufreq_frequency_table msm7600_freq_table[] = {
#if defined(CONFIG_JESUS_PHONE)
        { 0,  19200 },
        { 1, 176000 },
        { 2, 264000 },
...
//        TABLE_CONFIG(BUZZC, 72xx),
        TABLE_CONFIG(HERO, 7200),
//        TABLE_CONFIG(SAPPHIRE, 72xx),
        TABLE_CONFIG(HEROC, 7600),
...
static void __init acpuclk_init(void)
{
	...
	if (rc < 0)
		pr_err("Setting AXI min rate failed!\n");
       // Not used on heroc, see if hero can work without this
#if 0
	for (speed = acpu_freq_tbl; speed->a11clk_khz != 0; speed++)
		;
